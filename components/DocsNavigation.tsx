...
export default function DocsNavigation() {
    ...
    return (
        <div className='md:flex hidden'>
            <nav className="basic-transition w-[250px] h-screen flex px-4 py-10 flex-column border-x border-slate-200 bg-white dark:darkmode-background dark:border-slate-700">
                <div className='grow fixed'>
