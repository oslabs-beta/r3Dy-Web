...
export default function DocsNavigation() {
  ...
  return (
    <nav className="basic-transition fixed w-[250px] h-screen flex px-4 py-10 flex-column border-x border-slate-200 bg-white dark:darkmode-backround dark:border-slate-700">
    <div className='grow'>
        <div className="basic-transition py-2 px-4 rounded-md bg-slate-100 mb-8 max-w-[150px] text-sm dark:text-white dark:bg-slate-700">R3DY v1.0</div>
            ...
            <button onClick={() => setDropdown(!dropdown)} className="ease-linear transition duration-150 grow w-full doc-link">
