...
// console.log(...spring)
    ...
    {/* <OrbitControls makeDefault={ true }/> */}
        <group>
            ...
            <mesh position-z={-.5} scale={ 3 }>
                <planeGeometry args ={[5,3]} />
                <meshBasicMaterial wireframe={ false } color={ '#f0f0f0' } />
            </mesh>
            <mesh scale={ 3 }>
            ...
            <animated.mesh  {...spring} {...bind()}>
                <Text scale ={[2, 2, 2]} fontSize={.5}  castShadow position-y={1.5}  color={'black'} font={'fonts/Inter-Bold.ttf'}  overflowWrap='break-word'>{value}</Text>
