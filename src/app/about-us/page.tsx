...
export default function About() {
  return (
    <>
    <section className='py-16 md:py-28 px-8 flex justify-center'> 
      {/* HERO */}
      <div className='flex justify-center flex-col max-w-screen-lg'>
      <h1 id='project-contributors' className='text-5xl mb-8 text-center' >Just about R3DY</h1>
        <p id='landing-text' className='text-center'>Learn how we started and meet the developers that have contributed to R3DY UI’s <br/> growing library of components.</p>
      </div>
    </section>

    {/* STORY */}
    <section className=' py-16 md:py-28 px-8 flex justify-center border-t'>
      <div className='flex md:flex-row flex-col max-w-3xl content-center w-full text-center md:text-left'>
        <div className='md:pr-8'>
          <h2 className='text-indigo-700 text-2xl font-extrabold mb-4'>Our Story</h2>
          <h3 id='landing-text' className='mb-8'>R3DY UI was started on June 2023 by a team of remote engineers.</h3>
          <p>With the rise of VR/AR platforms and applications, we saw the need to further extend the capabilities of the already powerful Three.js and React to incorporate interactive and easy-to-implement 3D components. 
          <br/>
          <br/>
      ...
      {/* CONTRIBUTORS */}
    <section className='flex justify-center pb-20 border-t py-16 md:py-28'>
